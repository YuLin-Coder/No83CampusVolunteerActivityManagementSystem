...
public class UserController {
    ...
    @RequestMapping("/qryExcellentVolunteers")
    @ResponseBody
    public IPage<UserInfo> qryExcellentVolunteers(@RequestBody Page page){
        return userInfoService.qryExcellentVolunteers(page);
    }
}
